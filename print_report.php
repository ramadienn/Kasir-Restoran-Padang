...
<head>
    ...
    <style>
        body { font-family: 'Arial', sans-serif; font-size: 11pt; color: #333; line-height: 1.5; padding: 10px; }
        .header { text-align: center; border-bottom: 2px solid #444; margin-bottom: 20px; padding-bottom: 10px; }
        .header h1 { margin: 0; text-transform: uppercase; font-size: 20pt; color: #b45309; }
        .header p { margin: 2px 0; }
        
        table { width: 100%; border-collapse: collapse; margin-top: 10px; }
        th { background-color: #f3f4f6 !important; -webkit-print-color-adjust: exact; border: 1px solid #999; padding: 10px; text-align: center; }
        ...
        .footer-info { margin-top: 40px; display: flex; justify-content: space-between; }
...
<body onload="window.print()">
    ...
    <div style="margin-bottom: 20px;">
        <h3 style="text-align: center; text-decoration: underline;">LAPORAN TRANSAKSI PENJUALAN</h3>
        <table style="border: none; width: auto;">
            ...
            <tr><td style="border: none; padding: 2px;">Waktu Cetak</td><td style="border: none; padding: 2px;">: <?php echo date('d/m/Y H:i:s'); ?></td></tr>
        </table>
    </div>
    ...
    <div class="footer-info">
        <div>
            <p style="font-size: 9pt; color: #666;">* Dokumen ini dihasilkan secara otomatis oleh sistem manajemen RM Padang.</p>
        </div>
        <div class="signature">
            <p>Tangerang Selatan, <?php echo date('d') . ' ' . $nama_bulan[(int)date('m')] . ' ' . date('Y'); ?></p>
            <p style="margin-top: 70px;">( ____________________ )</p>
            <p><strong>Admin Operasional</strong></p>
        </div>
    </div>

    <div class="no-print" style="margin-top: 50px; text-align: center;">
        <hr>
        <button onclick="window.print()" style="padding: 10px 20px; cursor: pointer; background: #b45309; color: white; border: none; border-radius: 4px; font-weight: bold;">Cetak Laporan</button>
        <button onclick="window.close()" style="padding: 10px 20px; cursor: pointer; background: #6b7280; color: white; border: none; border-radius: 4px;">Tutup</button>
    </div>
